                    ...
                    <tbody>
                        ...
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                ...
                                <p style="margin-left: 50px ;">{{ $product->code}}</p>
                            </td>
                            <td>{{ $product->name }}</td>
                            <td>{{ $product->price }}</td>
                            ...
                            <td>
                                @if($product->image)
                                <a href="{{ url('storage/' .$product->image->id . '/' . $product->image->file_name) }}" target="_blank">
                                    <img src="{{ url('storage/' .$product->image->id . '/' . $product->image->file_name) }}" width="45px" height="45px" />
                                </a>
                                @else
